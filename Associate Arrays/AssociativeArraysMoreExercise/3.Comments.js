// Write a function that stores information about users and their comments in a website. You have to store the users, 
// the comments as an object with title and content and the article that comment is about. The user can only comment,
//  when he is on the list of users and the article is in the list of articles. The input comes as array of strings. 
//  The strings will be in format:
